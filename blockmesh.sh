...
KUNING='\033[1;33m'  # Changed from CYAN to KUNING (Yellow)
MAGENTA='\033[1;35m'
NC='\033[0m'

curl -s https://raw.githubusercontent.com/choir94/Airdropguide/refs/heads/main/logo.sh | bash
echo -e "${KUNING}Memulai Docker dan Block-Mesh...${NC}"  # Updated color
sleep 5
...
log() {
    ...
    echo -e "-----------------------------------------------------"
    case $level in
        "INFO") echo -e "${KUNING}[INFO] ${timestamp} - ${message}${NC}" ;;  # Updated color
